...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Treasured Spry Bat</title>
        <meta property="og:title" content="Treasured Spry Bat" />
      </Helmet>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                <span className="home-nav121 bodySmall">About</span>
                <span className="home-nav221 bodySmall">Products</span>
                <span className="home-nav321 bodySmall">Impact</span>
        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            ...
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>Building Trust, Saving Lives</span>
                  <span>
                    <span
            ...
            <div className="home-btn-group">
              <button className="buttonFilled">Donate Now</button>
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <h2 className="home-features-heading heading2">
                Unleashing the Power of Military Air Drones
              </h2>
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Experience the next generation of unmanned aerial vehicles
                    </span>
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
            ...
            <div className="home-container03">
              <FeatureCard
                ...
                subHeading="Utilizing cutting-edge technology for superior performance"
              ></FeatureCard>
              <FeatureCard
                heading="Precision Engineering"
                subHeading="Engineered with precision for accurate and efficient operations"
              ></FeatureCard>
              <FeatureCard
                heading="Long Range Capability"
                subHeading="Capable of covering vast distances for extended missions"
              ></FeatureCard>
              <FeatureCard
                heading="Versatile Functionality"
                subHeading="Designed to adapt to various military needs and scenarios"
              ></FeatureCard>
            </div>
          </div>
        </div>
      ...
      <div className="home-pricing">
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <h2 className="heading2">Choose the Plan that Fits Your Needs</h2>
            <span className="home-pricing-sub-heading bodyLarge">
              <span>
                <span>
                  Unlock the full potential of military air drones with our
          ...
          <div className="home-container05">
              ...
              <div className="home-container08">
                <div className="home-container09">
                  ...
                  <span className="bodySmall">
                    Limited drone models available
                  </span>
                </div>
                <div className="home-container10">
                  <span className="home-text41">✔</span>
                  <span className="bodySmall">Basic technical support</span>
                </div>
              </div>
            ...
            <div className="basicPricingCard home-pricing-card1">
              <div className="home-container11">
                ...
                <span className="bodySmall">
                  Enhanced features for drone enthusiasts
                </span>
              </div>
              ...
              <div className="home-container13">
                ...
                <div className="home-container15">
                  ...
                  <span className="bodySmall">
                    Expanded range of drone models
                  </span>
                </div>
                <div className="home-container16">
                  <span className="home-text50">✔</span>
                  <span className="bodySmall">Priority technical support</span>
                </div>
                <div className="home-container17">
                  <span className="home-text51">✔</span>
                  <span className="bodySmall">
                    Access to exclusive drone accessories
                  </span>
                </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              ...
              <div className="home-container21">
                ...
                <div className="home-container23">
                  ...
                  <span className="bodySmall">
                    Full range of drone models available
                  </span>
                </div>
                ...
                <div className="home-container25">
                  ...
                  <span className="bodySmall">
                    Access to advanced drone accessories
                  </span>
                </div>
      ...
      <div className="home-banner">
        <div className="bannerContainer home-banner1">
          <h1 className="home-banner-heading heading2">
            Developing and Manufacturing Military Air Drones
          </h1>
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  We are a volunteer organization dedicated to developing and
                  manufacturing cutting-edge military air drones for the
                  Ukrainian Army. Our mission is to provide the Ukrainian Army
                  with the necessary tools to defend their country and protect
                  innocent lives.
                </span>
                <span>
                  <span
        ...
        <footer className="footerContainer home-footer1">
          <div className="home-container27">
            ...
            <nav className="home-nav1">
              <span className="bodySmall">About</span>
              <span className="home-nav222 bodySmall">Products</span>
              <span className="home-nav322 bodySmall">Impact</span>
              <span className="home-nav422 bodySmall">Team</span>
              <span className="home-nav522 bodySmall">Contact</span>
            </nav>
          </div>
          <div className="home-separator"></div>
          <div className="home-container28">
            <span className="bodySmall home-text80">
